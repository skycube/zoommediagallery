...
<tr>
	<td align="center" valign="middle">
		<a href="<?php if($pid==$imgid) echo "#"; else echo "index.php?option=com_zoom&page=view&imgid=".$pid."&hit=".$hit;?>"><img src="components/com_zoom/images/back.gif" border="0" width="25" height="25" alt="<?php echo _ZOOM_PREVPIC;?>"></a>
		...
		<a href="<?php if($nid==$imgid) echo "#"; else echo "index.php?option=com_zoom&page=view&imgid=".$nid."&hit=".$hit;?>"><img src="components/com_zoom/images/next.gif" border="0" alt="<?php echo _ZOOM_NEXTPIC;?>"></a>
	</td>
</tr>
</table>
<?php
...
<table width="100%" border="0" cellspacing="0" cellpadding="3">
  <tr>
	...
	<table width="95%" border="0">
		...
		<tr>
			<td align="left"><?php echo _ZOOM_PICNAME;?>:</td><td align="left"><?php echo $row['filename'];?></td>
		</tr>
		<tr>
	...
	if ($zoom->_CONFIG['ratingOn']){
		...
		<tr class="sectiontableheader">
			<td colspan="6"><strong><font color="#ffffff"><?php echo _ZOOM_RATING;?></font></strong></td>
		</tr>
		<tr>
