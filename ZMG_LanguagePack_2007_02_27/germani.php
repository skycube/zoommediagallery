...
define("_ZOOM_SETTINGS_LIGHTBOX_SLIDESHOW","<strong><i>AKTIVIERE DIESE OPTION, DAMIT DIASHOWS MIT LIGHTBOX-JS ARBEITEN</i></strong>");
...
define("_ZOOM_COMMENTS_INTRO","Gebe hier Dein Kommentar ein:");
...
define ('_ZOOM_INSTALL_MESS2','HINWEIS: Die erste Sache die Du tun solltest, ist im Men&uuml; "Components" nach dem Eintrag <br> "zOOm Media Gallery" zu schauen und es anzuklicken.<br>Stelle dann unter "Einstellungen" alles nach Deinen Bed&uuml;rfnissen ein.');
...
define ('_ZOOM_INSTALL_MESS_FAIL3','Wenn Du diese Verzeichnisse erstellt hast, gehe zu <br /> "Components -> zOOm Media Gallery" und &auml;ndere die Einstellungen f&uuml;r Dich ab.');
?>
