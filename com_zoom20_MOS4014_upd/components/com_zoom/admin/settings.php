...
if($submit){
	...
	$zoom->saveConfig($s01,$s02,$s03,$s04,$s05,$s06,$s07,$s08,$s09,$s10,$s11,$s12,$s13,$s14,$s15,$s16);
	?>
	<SCRIPT>
...
<?php echo _ZOOM_SETTINGS_CONVTYPE;?> <select name="s01" size="1" tabindex="1" class="inputbox">
			...
			</select>  <?php echo _ZOOM_SETTINGS_IMGPATH;?> <input type="text" name="s02" value="<?php echo $zoom->_CONFIG['imagepath'];?>" size="24" tabindex="2" class="inputbox"><br>
			1 = ImageMagick<br>
			2 = NetPBM<br>
			3 = GD2 library
			<hr align="left" noshade width="100%">
			<?php echo _ZOOM_SETTINGS_CONVSETTINGS;?><br>
			<?php echo _ZOOM_SETTINGS_IMPATH;?><input type="text" name="s03" value="<?php echo $zoom->_CONFIG['IM_path'];?>" size="24" tabindex="3" class="inputbox"><?php echo _ZOOM_SETTINGS_NETPBMPATH;?><input type="text" name="s04" value="<?php echo $zoom->_CONFIG['NETPBM_path'];?>" size="24" tabindex="4" class="inputbox">
			...
			<table border="0" cellspacing="3" cellpadding="3">
				...
				<tr>
					<td class="settingslower"><input type="text" name="s07" size="5" maxlength="2" value="<?php echo $zoom->_CONFIG['columnsno'];?>" tabindex="5" class="inputbox"></td>
					<td class="settingslower"><input type="text" name="s08" size="5" maxlength="2" value="<?php echo $zoom->_CONFIG['PageSize'];?>" tabindex="6" class="inputbox"></td>
					<td class="settingslower"><select name="s09" size="1" tabindex="7" class="inputbox">
					...
					<td class="settingslower"><select name="s10" size="1" tabindex="8" class="inputbox">
					...
					<td class="settingslower"><select name="s11" size="1" tabindex="9" class="inputbox">
					...
					<td class="settingslower"><select name="s12" size="1" tabindex="10" class="inputbox">
					...
					<td class="settingslower"><select name="s13" size="1" tabindex="11" class="inputbox">
				...
				<tr>
					<td class="settingslower"><select name="s14" size="1" tabindex="10" class="inputbox">
			...
			<?php echo _ZOOM_SETTINGS_USERUPL;?>&nbsp;<select name="s15" size="1" tabindex="12" class="inputbox">
			...
			<p align="center"><input type="submit" name="submit" value="<?php echo _ZOOM_SAVE;?> " tabindex="13" class="button">  <input type="reset" tabindex="14" class="button"></p>
		</form>
</td></tr>
</table>