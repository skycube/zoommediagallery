...
<HEAD>
<TITLE>zOOm Gallery - <?echo $row['name'];?></TITLE>
...
<tr>
	<td align="center" valign="middle">
		<a href="view.php?imgid=<?php echo $pid;?>&hit=<?php echo $hit;?>"><img src="images/back.gif" border="0" width="25" height="25" alt="<?php echo _ZOOM_PREVPIC;?>"></a>
		<a href="javascript:stopstatus=0;runSlideShow();CSAction(new Array(/*CMP*/'9661D2'))" csclick="9661D2"><img src="images/play.gif" border="0" width="25" height="25" alt="<?php echo _ZOOM_PLAY;?>"></a> <a href="javascript:endSlideShow();CSAction(new Array(/*CMP*/'9A3103'))" csclick="9A3103"><img src="images/stop.gif" border="0" width="25" height="25" alt="<?php echo _ZOOM_STOP;?>"></a>
		<a href="view.php?imgid=<?php echo $nid;?>&hit=<?php echo $hit;?>"><img src="images/next.gif" border="0" alt="<?php echo _ZOOM_NEXTPIC;?>"></a>
	</td>
</tr>
</table>
<?php
...
?>
<img src="../../<?php echo $zoom->_CONFIG['imagepath'].$cat->catdir."/".$row['name']; ?>" alt="" border="1" name="zImage">
...
<table width="100%" height="95%" border="0" cellspacing="0" cellpadding="3">
  <tr>
	...
	<table width="95%" border="0">
		...
		<tr>
			<td width="125" align="left"><?php echo _ZOOM_PICNAME;?>:</td><td align="left"><?php echo $row['name'];?></td>
		</tr>
		<tr>
	...
	<table width="95%" border="0">
		...
		while ($row2 = mysql_fetch_array($result)){
	        ...
	        if ($isAdmin){
	        	...
	        	print "<tr><td width=\"125\" align=\"left\">".$row2['name'].":&nbsp;</td><td align=\"left\"><font color=\"#ff0000\">".$theComment."</font>&nbsp;(".$row2['date'].")</td><td width=\"50\"><a href=\"#\" onClick=\"newLoc(".$row['id']."); return true\">"._ZOOM_DELETE."</a></td></tr>";
	        }
	        else{
