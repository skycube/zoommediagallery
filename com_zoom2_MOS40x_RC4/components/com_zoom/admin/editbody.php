...
-----------------------------------------------------------------------
**/
$sql2 = "SELECT catname, catdescr FROM ".$dbprefix."zoom WHERE id=$theId";
$result2 = $database->openConnectionWithReturn($sql2);
$row2 = mysql_fetch_array($result2);
?>
<br>
<CENTER>
<FORM  name="edit_cat" ACTION="index.php?option=com_zoom&page=edit&Itemid=<?php echo $Itemid;?>" METHOD="POST">
