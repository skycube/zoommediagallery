...
<tr>
	<td align="center" valign="middle">
		<a href="<?php if($pid==$first_img) echo "#"; else echo "view.php?imgid=".$first_img."&hit=".$hit;?>"><img src="images/first_img.gif" border="0" width="25" height="25" alt="<?php echo _ZOOM_FIRST_IMG;?>"></a>
		<a href="<?php if($pid==$imgid) echo "#"; else echo "view.php?imgid=".$pid."&hit=".$hit;?>"><img src="images/prev.gif" border="0" width="25" height="25" alt="<?php echo _ZOOM_PREV_IMG;?>"></a>
		<?php
			if ($zoom->_CONFIG['slideshow']){ //Display play & stop buttons?
		?>
		<a href="#" onClick="stopstatus=0;runSlideShow()"><img src="images/play.gif" border="0" width="25" height="25" alt="<?php echo _ZOOM_PLAY;?>"></a> <a href="#" onClick="endSlideShow()"><img src="images/stop.gif" border="0" width="25" height="25" alt="<?php echo _ZOOM_STOP;?>"></a>
		<?php
			}
		?>
		<a href="<?php if($nid==$imgid) echo "#"; else echo "view.php?imgid=".$nid."&hit=".$hit;?>"><img src="images/next.gif" border="0" alt="<?php echo _ZOOM_NEXT_IMG;?>"></a>
		<a href="<?php if($pid==$last_img) echo "#"; else echo "view.php?imgid=".$last_img."&hit=".$hit;?>"><img src="images/last_img.gif" border="0" width="25" height="25" alt="<?php echo _ZOOM_LAST_IMG;?>"></a>
	</td>
</tr>
</table>
<?php
if ($zoom->_CONFIG['zoomOn']){
echo '<img src="../../'.$zoom->_CONFIG['imagepath'].$cat->catdir."/".$row['filename'].'" alt="" border="1" name="zImage">';
?>
...
<table width="100%" height="95%" border="0" cellspacing="0" cellpadding="3">
  <tr>
	...
	<table width="95%" border="0">
		...
		<tr>
			<td width="125" align="left"><?php echo _ZOOM_IMGNAME;?>: </td><td align="left"><?php echo $row['name'];?></td>
		</tr>
		<tr>
			<td width="125" align="left"><?php echo _ZOOM_FILENAME;?>: </td><td align="left"><?php echo $row['filename'];?></td>
		</tr>
		<tr>
...
?>
	...
	<table width="95%" border="0">
		...
		while ($row2 = mysql_fetch_array($result)){
	        ...
	        $theComment = $zoom->processSmilies($theComment,"",$smilies);	        
	        if ($isAdmin){
...
if ($zoom->_CONFIG['ratingOn']){
	...
	<tr>
		<td colspan="6" align="left" class="sectiontableheader"><?php echo _ZOOM_RATING;?></td>
	</tr>
	<tr>
